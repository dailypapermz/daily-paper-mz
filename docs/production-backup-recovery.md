...
| LLM key/base URL | GitHub production Environment (`LLM_API_BASE_URL` must be a Secret if credential-bearing) | Approved summary/tag operation succeeds; provider usage and logs show the new credential only |
